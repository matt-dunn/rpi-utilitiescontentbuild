...
class SCSSPHPTest extends \RPI\Test\Harness\Base
{
    ...
    {
        $this->assertContains(
            "v".\RPI\Utilities\ContentBuild\Processors\SCSSPHP::VERSION,
...
EOT;
    ...
    public function testProcessImportNoExtension()
    {
        ...
        $inputFilename = __DIR__."/SCSSPHPTest/test-import-noextension.scss";
...
EOT;
    ...
    public function testProcessImportMissing()
    {
        ...
        $inputFilename = __DIR__."/SCSSPHPTest/test-import-missing.scss";
    ...
    public function testProcessCustomFunction()
    {
        ...
        $inputFilename = __DIR__."/SCSSPHPTest/test-custom-functions.scss";
